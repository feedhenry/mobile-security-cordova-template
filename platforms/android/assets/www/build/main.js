...
var AuthPage = (function () {
    ...
    AuthPage.prototype.ionViewDidEnter = function () {
        ...
        var fingerprint = "24 C8 9A 60 4E 29 82 85 8E 4F 75 1F 78 46 CD B3 0A 08 66 3F";
        var self = this;
        sslCertificateChecker.check(successCallback, errorCallback, server, fingerprint);
        function successCallback(message) {
            self.authButtonState = true;
        }
